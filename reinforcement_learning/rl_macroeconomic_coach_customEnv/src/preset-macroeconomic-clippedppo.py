...
from rl_coach.base_parameters import VisualizationParameters, PresetValidationParameters, TaskParameters
from rl_coach.base_parameters import MiddlewareScheme, DistributedCoachSynchronizationType, EmbedderScheme
...
schedule_params.improve_steps = TrainingSteps(1000000) # 1000000
schedule_params.steps_between_evaluation_periods = EnvironmentSteps(2048)
schedule_params.evaluation_steps = EnvironmentEpisodes(10)
schedule_params.heatup_steps = EnvironmentSteps(50000) # 50000
...
agent_params.network_wrappers['main'].learning_rate = 0.00001 # 0.0003
...
agent_params.algorithm.discount = 0.97
...
agent_params.exploration.epsilon_schedule = LinearSchedule(1.0, 0.01, 750000)

###############
# Environment #
###############

env_params = GymVectorEnvironment(level='macroeconomic_env:MacroeconomicEnv')
